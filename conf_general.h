 ...
 */
	...
	!defined(HW_VERSION_DAS_MINI) && !defined(HW_VERSION_PALTA) && !defined(HW_VERSION_RH) && \
	!defined(HW_VERSION_TP) && !defined(HW_VERSION_75_300) && !defined(HW_VERSION_MINI4) && \
	!defined(HW_VERSION_DAS_MINI) && \
	!defined(HW_VERSION_60_VESCUINO_V01) && !defined(HW_VERSION_60_VESCUINO_V01A) && !defined(HW_VERSION_60_VESCUINO_V02) && !defined(HW_VERSION_60_VESCUINO_V02_SHUNT) && \
	!defined(HW_VERSION_60_MJVESC_V01)
...
//#define HW_VERSION_60_VESCUINO_V01	//cdi
//#define HW_VERSION_60_VESCUINO_V01A	//cdi
//#define HW_VERSION_60_VESCUINO_V02	//cdi
//#define HW_VERSION_60_VESCUINO_V02_SHUNT	//cdi - 2mohm shunt
#define HW_VERSION_60_MJVESC_V01	//cdi
#endif

// VESCuino_HW
#if defined(HW_VERSION_60_VESCUINO_V01) || \
    defined(HW_VERSION_60_VESCUINO_V01A) || \
	defined(HW_VERSION_60_VESCUINO_V02) || \
	defined(HW_VERSION_60_VESCUINO_V02_SHUNT) || \
	defined(HW_VERSION_60_MJVESC_V01)
#define USE_VESCUINO_PCB
#define USE_SD2_DEBUG_PRINTF
...
//#define USE_CUSTOM_ABI_ENCODER_AT_SPI	1	
#endif
...
#define MCCONF_DEFAULT_USER				"VESCuino/mcconf_custom_vescuino.h"	//cdi

/*
 * Select default user app configuration
 */
//#define APPCONF_DEFAULT_USER		"appconf_example_ppm.h"
#define APPCONF_DEFAULT_USER		"VESCuino/appconf_custom_vescuino.h"
...
#define APP_CUSTOM_TO_USE			"VESCuino/app_vescuino.c"	//cdi
...
void conf_general_get_default_custom_app_configuration(app_configuration *conf);	//cdi
