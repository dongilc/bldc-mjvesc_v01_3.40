...
void app_nunchuk_get_normalized_data(nunchuk_data_norm *chuk_data_norm); //cdi
...
float app_util_cdi_lowpass_filter(float in, float *out_prev, float hz, float dt);	//cdi
