/*
 * app_vescuino_mpu9250.h
 *
 *  Created on: 2018. 4. 6.
 *      Author: cdi
 */

#ifndef APPLICATIONS_APP_VESCUINO_MPU9250_H_
#define APPLICATIONS_APP_VESCUINO_MPU9250_H_
...
//
static bool app_mpu9250_start_flag = 0;
...
void mpu9250_param_update(void);

// I2C Functions
void status_i2c(msg_t st, uint8_t cmd_index);
//uint8_t writeByte_i2c(uint8_t address, uint8_t subAddress, uint8_t data);
//uint8_t writeByte_i2c(uint8_t addr, uint8_t data);
void writeByte_i2c(uint8_t dev_addr, uint8_t reg, uint8_t data);
//uint8_t readByte_i2c(uint8_t address, uint8_t subAddress);
//uint8_t readByte_i2c(uint8_t addr, uint8_t data);
...
#endif /* APPLICATIONS_APP_VESCUINO_MPU9250_H_ */
