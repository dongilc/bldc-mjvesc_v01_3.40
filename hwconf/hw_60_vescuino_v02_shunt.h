...
#ifndef HW_VERSION_60_VESCUINO_V02_SHUNT_H_
#define HW_VERSION_60_VESCUINO_V02_SHUNT_H_

#define HW_NAME					"60_VESCUINO_V02_SHUNT"	//cdi
...
#define USART3_RS485_MODE()		palSetPad(GPIOD, 13)
#define USART3_DEFAULT_MODE()	palClearPad(GPIOD, 13)
...
#define CURRENT_SHUNT_RES		0.002 //0.0005
#endif
...
// MPU9250 SPI SW pins
#define MPU_PORT_CSN			GPIOD
#define MPU_PIN_CSN				11
#define MPU_PORT_SCK			GPIOD
#define MPU_PIN_SCK				7
#define MPU_PORT_MOSI			GPIOD
#define MPU_PIN_MOSI			3
#define MPU_PORT_MISO			GPIOD
...
#endif /* HW_VERSION_60_VESCUINO_V02_SHUNT_H_ */
