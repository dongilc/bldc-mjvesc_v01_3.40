...
//cdi
void conf_general_get_default_custom_app_configuration(app_configuration *conf) {
	// custom app default value
	conf->app_custom.custom_app_mode = CUSTOM_APP_MODE;

	conf->app_custom.custom_imu_use_mode = CUSTOM_IMU_USE_MODE;
	conf->app_custom.custom_imu_comm_mode[0] = CUSTOM_IMU_COMM_MODE_1ST;
	conf->app_custom.custom_imu_comm_mode[1] = CUSTOM_IMU_COMM_MODE_2ND;
	conf->app_custom.custom_imu_setup_mode[0] = CUSTOM_IMU_SETUP_MODE_1ST;
	conf->app_custom.custom_imu_setup_mode[1] = CUSTOM_IMU_SETUP_MODE_2ND;
	conf->app_custom.custom_imu_dof[0] = CUSTOM_IMU_DOF_1ST;
	conf->app_custom.custom_imu_dof[1] = CUSTOM_IMU_DOF_2ND;
	conf->app_custom.custom_imu_quaternion_filter_mode = CUSTOM_IMU_QUATERNION_FILTER_MODE;
	conf->app_custom.custom_imu_ascale = CUSTOM_IMU_ASCALE;
	conf->app_custom.custom_imu_gscale = CUSTOM_IMU_GSCALE;
	conf->app_custom.custom_imu_mscale = CUSTOM_IMU_MSCALE;
	conf->app_custom.custom_imu_m_mode = CUSTOM_IMU_M_MODE;
	conf->app_custom.custom_imu_rate_freq = CUSTOM_IMU_RATE_FREQ;

	// 1st mpu param
	conf->app_custom.custom_imu_gyro_bias[0][0] = CUSTOM_IMU_GYRO_BIAS_X;
	conf->app_custom.custom_imu_gyro_bias[0][1] = CUSTOM_IMU_GYRO_BIAS_Y;
	conf->app_custom.custom_imu_gyro_bias[0][2] = CUSTOM_IMU_GYRO_BIAS_Z;

	conf->app_custom.custom_imu_accel_bias[0][0] = CUSTOM_IMU_ACC_BIAS_X;
	conf->app_custom.custom_imu_accel_bias[0][1] = CUSTOM_IMU_ACC_BIAS_Y;
	conf->app_custom.custom_imu_accel_bias[0][2] = CUSTOM_IMU_ACC_BIAS_Z;

	conf->app_custom.custom_imu_use_acc_bias_user[0] = CUSTOM_IMU_USE_ACCEL_BIAS_USER_1ST;
	conf->app_custom.custom_imu_accel_bias_user[0][0] = CUSTOM_IMU_ACCEL_BIAS_USER_X_1ST;
	conf->app_custom.custom_imu_accel_bias_user[0][1] = CUSTOM_IMU_ACCEL_BIAS_USER_Y_1ST;
	conf->app_custom.custom_imu_accel_bias_user[0][2] = CUSTOM_IMU_ACCEL_BIAS_USER_Z_1ST;

//	conf->app_custom.custom_imu_mag_bias[0][0] = CUSTOM_IMU_MAG_BIAS_X;
//	conf->app_custom.custom_imu_mag_bias[0][1] = CUSTOM_IMU_MAG_BIAS_Y;
//	conf->app_custom.custom_imu_mag_bias[0][2] = CUSTOM_IMU_MAG_BIAS_Z;
//	conf->app_custom.custom_imu_mag_scale[0][0] = CUSTOM_IMU_MAG_SCALE_X;
//	conf->app_custom.custom_imu_mag_scale[0][1] = CUSTOM_IMU_MAG_SCALE_Y;
//	conf->app_custom.custom_imu_mag_scale[0][2] = CUSTOM_IMU_MAG_SCALE_Z;

	// 2nd mpu param
	conf->app_custom.custom_imu_gyro_bias[1][0] = CUSTOM_IMU_GYRO_BIAS_X;
	conf->app_custom.custom_imu_gyro_bias[1][1] = CUSTOM_IMU_GYRO_BIAS_Y;
	conf->app_custom.custom_imu_gyro_bias[1][2] = CUSTOM_IMU_GYRO_BIAS_Z;

	conf->app_custom.custom_imu_accel_bias[1][0] = CUSTOM_IMU_ACC_BIAS_X;
	conf->app_custom.custom_imu_accel_bias[1][1] = CUSTOM_IMU_ACC_BIAS_Y;
	conf->app_custom.custom_imu_accel_bias[1][2] = CUSTOM_IMU_ACC_BIAS_Z;

	conf->app_custom.custom_imu_use_acc_bias_user[1] = CUSTOM_IMU_USE_ACCEL_BIAS_USER_2ND;
	conf->app_custom.custom_imu_accel_bias_user[1][0] = CUSTOM_IMU_ACCEL_BIAS_USER_X_2ND;
	conf->app_custom.custom_imu_accel_bias_user[1][1] = CUSTOM_IMU_ACCEL_BIAS_USER_Y_2ND;
	conf->app_custom.custom_imu_accel_bias_user[1][2] = CUSTOM_IMU_ACCEL_BIAS_USER_Z_2ND;

//	conf->app_custom.custom_imu_mag_bias[1][0] = CUSTOM_IMU_MAG_BIAS_X;
//	conf->app_custom.custom_imu_mag_bias[1][1] = CUSTOM_IMU_MAG_BIAS_Y;
//	conf->app_custom.custom_imu_mag_bias[1][2] = CUSTOM_IMU_MAG_BIAS_Z;
//	conf->app_custom.custom_imu_mag_scale[1][0] = CUSTOM_IMU_MAG_SCALE_X;
//	conf->app_custom.custom_imu_mag_scale[1][1] = CUSTOM_IMU_MAG_SCALE_Y;
//	conf->app_custom.custom_imu_mag_scale[1][2] = CUSTOM_IMU_MAG_SCALE_Z;

	//ctm
//	conf->app_custom.custom_ctm_freq = CUSTOM_CTM_FREQ;
//	conf->app_custom.custom_ctm_spillover_filter_freq = CUSTOM_CTM_SPILLOVER_FILTER_FREQ;
//	conf->app_custom.custom_ctm_Kp = CUSTOM_CTM_KP;
//	conf->app_custom.custom_ctm_Kd = CUSTOM_CTM_KD;
//	conf->app_custom.custom_ctm_current_limit_flag = CUSTOM_CTM_CURRENT_LIMIT_FLAG;
//	conf->app_custom.custom_ctm_current_limit = CUSTOM_CTM_CURRENT_LIMIT;

	//cdi, smg
	conf->app_custom.smg_control_mode = CUSTOM_SMG_CONTROL_MODE;
	conf->app_custom.smg_control_freq = CUSTOM_SMG_CONTROL_FREQ;
	conf->app_custom.spillover_filter_flag = CUSTOM_SMG_SPILLOVER_FILTER_FLAG;
	conf->app_custom.spillover_filter_hz = CUSTOM_SMG_SPILLOVER_FILTER_FREQ;
	conf->app_custom.current_limit_flag = CUSTOM_SMG_CURRENT_LIMIT_FLAG;
	conf->app_custom.current_limit = CUSTOM_SMG_CURRENT_LIMIT;

	conf->app_custom.LQR_X[0] = CUSTOM_SMG_LQR_X_0;
	conf->app_custom.LQR_X[1] = CUSTOM_SMG_LQR_X_1;
	conf->app_custom.LQR_X[2] = CUSTOM_SMG_LQR_X_2;
	conf->app_custom.LQR_X[3] = CUSTOM_SMG_LQR_X_3;

//	conf->app_custom.LQR_Y[0] = CUSTOM_SMG_LQR_Y_0;
//	conf->app_custom.LQR_Y[1] = CUSTOM_SMG_LQR_Y_1;
//	conf->app_custom.LQR_Y[2] = CUSTOM_SMG_LQR_Y_2;
//	conf->app_custom.LQR_Y[3] = CUSTOM_SMG_LQR_Y_3;
//
//	conf->app_custom.LQR_Z[0] = CUSTOM_SMG_LQR_Z_0;
//	conf->app_custom.LQR_Z[1] = CUSTOM_SMG_LQR_Z_1;
//	conf->app_custom.LQR_Z[2] = CUSTOM_SMG_LQR_Z_2;
//	conf->app_custom.LQR_Z[3] = CUSTOM_SMG_LQR_Z_3;
...
void conf_general_read_app_configuration(app_configuration *conf) {
	...
	if (!is_ok) {
		...
		conf_general_get_default_custom_app_configuration(conf); //cdi
	}
}
